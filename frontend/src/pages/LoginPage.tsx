      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">VideoHelper</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">AI Video Generation Platform</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-1">
              Change via <span className="font-mono">AUTH_USERNAME</span> and <span className="font-mono">AUTH_PASSWORD</span> environment variables
            </p>
          </div>
        </div>
      </div>
